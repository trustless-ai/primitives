...
live_onchain = [
  ...
  ("truth-anchor","TruthAnchor — ERC-8281 OCP (ours)",
   "Our ERC-8281 commitment anchor: record(digest)->Recorded; /verify showcase L3 reads it. "
   "Distinct from Vincent Wu's ERC-8263 TruthAnchorV1 (a separate primitive).",
...
surfaces = [
  ...
  ("surface:verify-showcase","ai.verticecriativo.pt/verify",
   "The /verify four-surface recompute showcase (WYRIWE L1-L3 + EIP-712 L4 + on-chain anchor).",
   "https://ai.verticecriativo.pt/verify"),
  ("surface:review","ai.verticecriativo.pt/review",
   "invinoveritas /review verdict — recompute a signed review in-browser (NIP-01 + BIP-340).",
   "https://ai.verticecriativo.pt/review"),
